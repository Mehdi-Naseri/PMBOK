...
namespace Pmbok.Areas.Admin.Controllers
{
    public class LogsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DateTime,Title,Message,Timestamp")] Log log)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DateTime,Title,Message,Timestamp")] Log log)
        {
            if (ModelState.IsValid)
            {
